...
import 'package:quizon/quiz/quiz_state.dart';
import 'package:quizon/services/firestore.dart';
import 'package:quizon/shared/loading.dart';
import 'package:quizon/shared/progress_bar.dart';
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: FutureBuilder<Quiz>(
          future: FirestoreServices().getQuiz(quizId),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton.icon(
            onPressed: () {
              FirestoreServices().updateUserReport(quiz);
